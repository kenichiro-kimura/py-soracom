...
def listSoraCamDevices(self):
    return apiClient.callAPI(self,url="/sora_cam/devices", method="GET")

def getSoraCamDevice(self,deviceID):
    return apiClient.callAPI(self,url="/sora_cam/devices/" + deviceID, method="GET")

def getSoraCamDeviceExportUsage(self,deviceID):
    return apiClient.callAPI(self,url="/sora_cam/devices/" + deviceID + "/exports/usage", method="GET")
...
def listSoraCamDeviceImageExportsForDevice(self,deviceID,**kwargs):
    ...
    return apiClient.callAPI(self,url=url, method="GET")

def exportSoraCamDeviceRecordedImage(self,deviceID,time):
    body = {
        "time": time
    }
    return apiClient.callAPI(self,url="/sora_cam/devices/" + deviceID + "/images/exports", method="POST",body=body)

def getSoraCamDeviceExportedImage(self,deviceID,exportID):
    return apiClient.callAPI(self,url="/sora_cam/devices/" + deviceID + "/images/exports/" + exportID, method="GET")
...
def exportSoraCamDeviceRecordedVideo(self,deviceID,fromTime,toTime):
    ...
    return apiClient.callAPI(self,url="/sora_cam/devices/" + deviceID + "/videos/exports", method="POST",body=body)

def getSoraCamDeviceExportedVideo(self,deviceID,exportID):
    return apiClient.callAPI(self,url="/sora_cam/devices/" + deviceID + "/videos/exports/" + exportID, method="GET")
...
def listSoraCamLicensePacks(self):
    return apiClient.callAPI(self,url="/sora_cam/license_packs", method="GET")
...
def updateSoraCamLicensePackQuantity(self,licensePackID,currentQuantity,desiredQuantity):
    ...
    return apiClient.callAPI(self,url="/sora_cam/license_packs/" + licensePackID + "/quantity", method="PUT",body=body)